...
<body>
    ...
    <div class="container">
        ...
        <h1> Create
            <br><small> Generates an iCal file for a new event.</small>
        </h1>
        
        <h3> New Event Generator:</h3><br>
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <div class="row">
                <div class="col-xs-2">Timezone: </div>
                <div class="col-xs-8">
                    <input type="radio" name="timezone" value="Pacific/Honolulu" checked> Hawaii
                    <input type="radio" name="timezone" value="America/Chicago">          Central
                    <input type="radio" name="timezone" value="America/New_York">         Eastern
                    <input type="radio" name="timezone" value="America/Denver">           Mountain
                    <input type="radio" name="timezone" value="America/Los_Angeles">      Pacific
                </div>
            </div><br>
            <div class="row">
